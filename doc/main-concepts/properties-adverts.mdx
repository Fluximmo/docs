...
OR Parameters: Apply to fields that are lists, facilitating a non-exclusive (OR) search behavior. This means you can retrieve data matching any of the specified criteria in these fields. For example if you have a list holdings `["HOUSE", "APARTMENT"]` you will receive ads that are either an apartment or an house.
